...
export const companies: Company[] = [
  ...
  },
  {
    ...
    tagline: 'Deep learning specialist backed by Anadea\'s 25-year software delivery track record.',
    ...
    teamSize: '50–100',
    rating: 4.5,
    badges: ['deep-learning', 'nlp', 'computer-vision', 'generative-ai', 'mlops', 'custom-ml'],
    ...
    primaryDifferentiator: 'Boutique deep learning specialist with direct senior engineer access and AWS Premier Partner status, backed by Anadea\'s 25-year delivery track record',
    ...
    industries: ['Healthcare', 'Hospitality', 'Financial Services', 'Edtech', 'Technology / SaaS'],
